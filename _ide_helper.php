 ...
 * Generated for Laravel 5.5.40 on 2018-07-20 14:22:43.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Response {
         ...
         * @static
         */
        public static function ajaxSuccess($message = '操作成功', $content = array())
        {
            return \Illuminate\Routing\ResponseFactory::ajaxSuccess($message, $content);
        }
         ...
         * @static
         */
        public static function ajaxFail($message = '操作失败', $content = array())
        {
            return \Illuminate\Routing\ResponseFactory::ajaxFail($message, $content);
        }
