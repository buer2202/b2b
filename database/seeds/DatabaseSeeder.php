...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // 插入权限
        $sql = [
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.user.index.index', '平台用户资料', '1', 'user', '用户管理', '1', '1', '10000', '2020-05-13 11:46', '2020-05-13 11:46')",
            ...
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.user.index.certification', '实名管理', '1', 'user', '用户管理', '0', '0', '10250', '2020-05-13 11:46', '2020-05-13 11:46')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.user.index.attachment', '查看认证图片', '1', 'user', '用户管理', '0', '0', '10251', '2020-05-13 11:46', '2020-05-13 11:46')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.user.index.audit', '实名审核', '1', 'user', '用户管理', '0', '0', '10252', '2020-05-13 11:46', '2020-05-13 11:46')",
