...
class PlatformSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $sql = [
            ...
            // 价格系统
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.price-system.price-group.index', '价格组管理', '1', 'price-system', '价格系统', '1', '1', '13000', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.price-system.price-group.store', '添加', '1', 'price-system', '价格系统', '0', '0', '13010', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.price-system.price-group.show', '编辑', '1', 'price-system', '价格系统', '0', '0', '13020', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.price-system.price-group.update', '更新', '1', 'price-system', '价格系统', '0', '0', '13030', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.price-system.price-group.search-user', '查找用户', '1', 'price-system', '价格系统', '0', '0', '13040', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.price-system.price-group-user.inside', '组内用户', '1', 'price-system', '价格系统', '0', '0', '13050', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.price-system.price-group-user.outside', '组外用户', '1', 'price-system', '价格系统', '0', '0', '13060', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.price-system.price-group-user.add', '添加组用户', '1', 'price-system', '价格系统', '0', '0', '13070', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.price-system.price-group-user.delete', '删除组用户', '1', 'price-system', '价格系统', '0', '0', '13080', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.price-system.price-group-user.move', '移动组用户', '1', 'price-system', '价格系统', '0', '0', '13090', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.price-system.price-group-goods.inside', '组内商品', '1', 'price-system', '价格系统', '0', '0', '13100', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.price-system.price-group-goods.outside', '组外商品', '1', 'price-system', '价格系统', '0', '0', '13110', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.price-system.price-group-goods.add', '添加组商品', '1', 'price-system', '价格系统', '0', '0', '13120', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.price-system.price-group-goods.edit-price', '编辑商品价格', '1', 'price-system', '价格系统', '0', '0', '13130', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.price-system.price-group-goods.delete', '删除组商品', '1', 'price-system', '价格系统', '0', '0', '13140', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.price-system.price-group-goods.update-price', '更新商品价格', '1', 'price-system', '价格系统', '0', '0', '13150', '{$now}', '{$now}')",
