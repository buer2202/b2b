...
class PlatformSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $sql = [
            ...
            // 商品价格
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.price-group.index', '价格组管理', '1', 'goods-price', '商品价格管理', '1', '1', '13000', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.price-group.store', '添加', '1', 'goods-price', '商品价格管理', '0', '0', '13010', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.price-group.show', '编辑', '1', 'goods-price', '商品价格管理', '0', '0', '13020', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.price-group.update', '更新', '1', 'goods-price', '商品价格管理', '0', '0', '13030', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.price-group.search-user', '查找用户', '1', 'goods-price', '商品价格管理', '0', '0', '13040', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.price-group-user.inside', '组内用户', '1', 'goods-price', '商品价格管理', '0', '0', '13050', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.price-group-user.outside', '组外用户', '1', 'goods-price', '商品价格管理', '0', '0', '13060', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.price-group-user.add', '添加组用户', '1', 'goods-price', '商品价格管理', '0', '0', '13070', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.price-group-user.delete', '删除组用户', '1', 'goods-price', '商品价格管理', '0', '0', '13080', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.price-group-user.move', '移动组用户', '1', 'goods-price', '商品价格管理', '0', '0', '13090', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.price-group-goods.inside', '组内商品', '1', 'goods-price', '商品价格管理', '0', '0', '13100', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.price-group-goods.outside', '组外商品', '1', 'goods-price', '商品价格管理', '0', '0', '13110', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.price-group-goods.add', '添加组商品', '1', 'goods-price', '商品价格管理', '0', '0', '13120', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.price-group-goods.edit-price', '编辑商品价格', '1', 'goods-price', '商品价格管理', '0', '0', '13130', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.price-group-goods.delete', '删除组商品', '1', 'goods-price', '商品价格管理', '0', '0', '13140', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.price-group-goods.update-price', '更新商品价格', '1', 'goods-price', '商品价格管理', '0', '0', '13150', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.separator-divider.1', '分割线', '1', 'goods-price', '商品价格管理', '1', '1', '13200', '{$now}', '{$now}')",
            // 基础分类管理
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.goods-category.index', '基础分类管理', '1', 'goods-price', '商品价格管理', '1', '1', '13300', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.goods-category.store', '添加', '1', 'goods-price', '商品价格管理', '0', '0', '13310', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.goods-category.show', '编辑', '1', 'goods-price', '商品价格管理', '0', '0', '13320', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.goods-category.update', '更新', '1', 'goods-price', '商品价格管理', '0', '0', '13330', '{$now}', '{$now}')",
            // 基础商品管理
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.goods.index', '基础商品管理', '1', 'goods-price', '商品价格管理', '1', '1', '13400', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.goods.store', '添加', '1', 'goods-price', '商品价格管理', '0', '0', '13410', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.goods.show', '编辑', '1', 'goods-price', '商品价格管理', '0', '0', '13420', '{$now}', '{$now}')",
            "INSERT INTO `admin_auth_rules` (`name`, `title`, `status`, `group`, `group_name`, `menu_show`, `menu_click`, `sortord`, `created_at`, `updated_at`) VALUES ('admin.goods-price.goods.update', '更新', '1', 'goods-price', '商品价格管理', '0', '0', '13430', '{$now}', '{$now}')",
