...
<form class="form-inline" id="data-form">
    ...
    <div class="form-group">
        <select class="form-control" name="trade_type">
            ...
            <option value="{{ $key }}" {{ $key == Request::input('trade_type') ? 'selected' : '' }}>{{ $key }}.
                {{ $value }}</option>
            @endforeach
        </select>
    </div>
    ...
    <div class="form-group">
        <select class="form-control" name="trade_subtype">
            ...
            <option value="{{ $key }}" {{ $key == Request::input('trade_subtype') ? 'selected' : '' }}>{{ $key }}.
                {{ $value }}</option>
            @endforeach
        </select>
    </div>
    ...
    <div class="form-group">
        <input type="text" class="form-control" placeholder="相关单号" name="trade_no"
            value="{{ Request::input('trade_no') }}">
    </div>
...
<table class="table table-striped table-condensed m-t">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><button class="btn btn-info btn-xs order"
                    data-url="{{ route('admin.finance.platform-amount-flow.order', $data->id) }}">查看</button></td>
        </tr>
        @endforeach
    </tbody>
</table>
...
<script src="/js/buer_export.js"></script>
<script>
    // 异步导出
